...
function getGameList (liveCode, page) {
  ...
  $.getJSON('/api/live/qst', data, function (response) {
    ...
    $.each(response.data, function (index, item) {
      var img_src = "";
      switch (item.liveCode) {
        case "cq9":
          img_src = "/data/gamePicture/cq/" + item.imageName;
          break;
        case "mg":
          img_src = "/data/mgPicture/" + item.imageName;
          break;
        case "jdb":
          img_src = "/data/jdbPicture/" + item.imageName;
          break;
        case "hb":
          img_src = "/data/hbPicture/" + item.imageName;
          break;
        case "png":
          img_src = "/data/pngPicture/" + item.imageName;
          break;
        case "pg":
          img_src = "/data/pgPicture/" + item.imageName;
          break;
        default:
